...
?>
  ...
  <!-- Hero Section -->
  <section class="hero" style="background: linear-gradient(rgba(214, 0, 110, 0.4), rgba(214, 0, 110, 0.6)), url('about_landscape.png') center/cover no-repeat; height: 500px; display: flex; align-items: center; justify-content: center; text-align: center;">
  ...
  <section class="about-section" style="padding: 100px 20px; overflow: hidden;">
    <div style="max-width: 1280px; margin: 0 auto; display: flex; align-items: center; gap: 80px; flex-wrap: wrap;">
      ...
      <div style="flex: 1; position: relative; height: 500px; min-width: 400px;">
        <img src="team_new.png" alt="Il Team <?= $brand ?>" class="hero-image-mask" style="border-radius: 300px 0 0 300px; box-shadow: -20px 20px 40px rgba(0,0,0,0.1);">
      </div>
    </div>
  </section>
