...
?>
  ...
  <main class="legal-content">
    ...
    <p>L’utente potrà esercitare i diritti previsti dagli artt. 15-22 GDPR, nonché revocare il consenso o opporsi a ulteriori contatti commerciali, scrivendo a <?= $titolareNome ?> ai recapiti indicati nella presente informativa.</p>
    ...
    <?php if ($emailDpo !== '') { ?>
    <p>DPO / RPD: <a href="mailto:<?= $emailDpo ?>"><?= $emailDpo ?></a></p>
    <?php } ?>
    ...
    <p>Le richieste possono essere inviate al Titolare ai recapiti indicati nella presente informativa.</p>
