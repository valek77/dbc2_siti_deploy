...
?>
      ...
      <div class="split">
        <div class="reveal">
          ...
          <p style="font-size:18px; color:var(--muted); line-height:1.75; margin: 0 0 24px;">
            <?= $OPERATORE['nome_marketing'] ?> nasce con un obiettivo preciso: rendere semplice e conveniente il passaggio al mercato libero dell'energia. Lavoriamo ogni giorno per portare ai clienti le migliori tariffe disponibili.
          </p>
  ...
  <section class="quote-banner">
    ...
    <p class="by">— Il Team <?= $OPERATORE['nome_marketing'] ?></p>
  </section>
