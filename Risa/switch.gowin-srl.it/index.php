        ...
        <div class="hero-slide active">
          ...
          <div class="container">
            <div class="hero-content">
              ...
              <p class="lede"><?= $OPERATORE['nome_marketing'] ?> ti guida nel mercato libero con offerte trasparenti. Prezzi indicizzati al mercato e zero burocrazia.</p>
  ...
  <section class="section how-it-works section-on-dark">
    <div class="container">
      <div class="section-head">
        ...
        <p class="section-sub">Cambiare fornitore con <?= $OPERATORE['nome_marketing'] ?> è veloce e non richiede alcun intervento tecnico in casa.</p>
      </div>
  ...
  <section class="section">
    <div class="container">
      <div class="split reverse">
        ...
        <div class="reveal">
          <span class="eyebrow"><span class="dot"></span> Perché scegliere <?= $OPERATORE['nome_marketing'] ?></span>
          ...
          <p style="font-size:17px; color:var(--muted); line-height:1.7; margin: 0 0 24px;">
            Con <?= $OPERATORE['nome_marketing'] ?> puoi scegliere tra offerte a prezzo variabile indicizzato al mercato o offerte SWITCH con spread fisso garantito per 12 mesi.
          </p>
      ...
      <div class="reviews-grid">
        <div class="rv-panel">
          <div>
            ...
            <p>Migliaia di famiglie e imprese hanno scelto <?= $OPERATORE['nome_marketing'] ?> per la loro fornitura di energia.</p>
          </div>
