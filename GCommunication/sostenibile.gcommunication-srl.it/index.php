...
?>
    ...
    <div class="hero-slider">
      <div class="hero-slides">
        <div class="hero-slide active">
          <img src="hero_multi_1.png" class="hero-slide-bg" alt="Telecomunicazioni e Internet">
          <div class="container">
            <div class="hero-content">
              ...
              <p class="lede"><?= $brandName ?> ti guida con offerte trasparenti per luce, gas, fibra e telefonia.</p>
        ...
        <div class="hero-slide">
          <img src="hero_multi_2.png" class="hero-slide-bg" alt="Assistenza Clienti">
          <div class="container">
            <div class="hero-content">
        ...
        <div class="hero-slide">
          <img src="hero_multi_3.png" class="hero-slide-bg" alt="Fibra Ottica">
          <div class="container">
            <div class="hero-content">
  ...
  <section class="trust-strip">
    <div class="trust-track">
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2l8 4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6l8-4z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Servizi Certificati</span>
      ...
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2v6m0 8v6m10-10h-6M8 12H2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="2"/></svg> Nessuna interruzione di servizio</span>
      ...
      <div class="features-staggered">
        <article class="stagger-item reveal">
          <div class="stagger-visual">
            <img src="feature_luce_real.png" alt="Luce e Gas">
          </div>
          <div class="stagger-content">
            <h4>Luce e Gas</h4>
            <p>Tariffe trasparenti per l'energia elettrica e il gas, con soluzioni su misura per abbattere i costi della tua bolletta.</p>
            <a href="tariffe.php" class="btn-ghost" style="margin-top:20px;">Vedi tariffe energia</a>
          </div>
        </article>

        <article class="stagger-item reveal">
          <div class="stagger-visual">
            <img src="feature_telecom.png" alt="Telefonia e Fibra">
          </div>
          <div class="stagger-content">
            <h4>Telefonia e Fibra</h4>
            <p>Connessioni ultraveloci e piani mobile per essere sempre connesso, sia a casa che in mobilità o in azienda.</p>
            <a href="tariffe.php" class="btn-ghost" style="margin-top:20px;">Vedi tariffe telecom</a>
          </div>
        </article>
        ...
        <article class="stagger-item reveal">
          ...
          <div class="stagger-content">
            ...
            <p>Analizziamo le tue attuali fatture telefoniche e proponiamo l'offerta più conveniente in pochi minuti. Senza impegno e con un consulente dedicato.</p>
            <a href="contatti.php" class="btn-ghost" style="margin-top:20px;">Richiedi consulenza</a>
          </div>
        </article>
      </div>
    </div>
      ...
      <div class="timeline">
        <div class="timeline-item reveal">
          ...
          <div class="timeline-content">
            ...
            <p>Confronta le tariffe Fibra o Mobile <?= $brandName ?> e individua quella più adatta al tuo profilo.</p>
          </div>
        </div>
        <div class="timeline-item reveal">
          <div class="timeline-dot"></div>
        ...
        <div class="timeline-item reveal">
          ...
          <div class="timeline-content">
            ...
            <h5>Invia i documenti</h5>
            <p>Ci occupiamo noi della pratica con il vecchio fornitore telefonico. Zero stress, zero burocrazia.</p>
          </div>
        </div>
        <div class="timeline-item reveal">
          <div class="timeline-dot"></div>
      ...
      <div class="split reverse">
        ...
        <div class="reveal">
          ...
          <p style="font-size:17px; color:var(--muted); line-height:1.7; margin: 0 0 24px;">
            Con <?= $brandName ?> puoi scegliere tra offerte internet super veloci e pacchetti voce+dati su misura per il tuo business.
          </p>
      ...
      <div class="reviews-grid">
        <div class="rv-panel">
          <div>
            ...
            <p>Migliaia di famiglie e imprese hanno scelto <?= $brandName ?> per le loro telecomunicazioni.</p>
          </div>
          ...
          <div class="rv-card">
            ...
            <div class="author">
              ...
              <div>
                ...
                <div class="author-meta">Cliente Fibra Casa</div>
              </div>
            </div>
          </div>
          <div class="rv-card">
            ...
            <p>Fattura ridotta di circa il 15% rispetto al vecchio fornitore. Ottima consulenza e prezzi davvero chiari.</p>
            <div class="author">
              <div class="avatar">LM</div>
              <div>
                <div class="author-name">Laura M.</div>
                <div class="author-meta">Cliente Fibra + Mobile</div>
              </div>
            </div>
          </div>
          <div class="rv-card">
            ...
            <p>Mi hanno spiegato bene le differenze tra le varie offerte e mi hanno aiutato a scegliere la tariffa più adatta per la mia azienda.</p>
            <div class="author">
              <div class="avatar">RT</div>
              <div>
                <div class="author-name">Roberto T.</div>
                <div class="author-meta">Cliente Aziendale</div>
              </div>
            </div>
          </div>
        </div>
  ...
  <section class="cta-final">
    <div class="container">
      ...
      <h2>Fattura più bassa, servizi più chiari.</h2>
