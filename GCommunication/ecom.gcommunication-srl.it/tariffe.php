  ...
  <section class="section" style="padding: 60px 0 100px;">
    <div class="container" style="max-width: 1000px; margin: 0 auto; padding: 0 24px;">
      ...
      <div class="offers-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(350px, 1fr)); gap: 32px; margin-bottom: 80px;">
        ...
        <!-- FAMILY GAS -->
        <div class="offer-card" style="border: 1px solid #E4E4E7; border-radius: 24px; overflow: hidden; display: flex; flex-direction: column; background: #fff; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
          <div class="offer-ribbon" style="background: var(--secondary); color: #fff; padding: 12px 24px; font-weight: 700; font-size: 14px; text-transform: uppercase; letter-spacing: 1px;">Gas Naturale</div>
          <div class="offer-body" style="padding: 40px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <div style="background: #FAFAFA; border-radius: 16px; padding: 24px; margin-bottom: 32px; border: 1px solid #F4F4F5;">
              ...
              <div style="font-size: 32px; font-weight: 800; color: var(--secondary); margin-bottom: 4px;">€ 0,210000<span style="font-size: 16px; color: #71717A;">/Smc</span></div>
            ...
            <ul style="list-style: none; padding: 0; margin: 0 0 32px; display: flex; flex-direction: column; gap: 16px; color: #3F3F46; font-size: 16px;">
              <li style="display: flex; gap: 12px;"><span style="color: var(--secondary); font-weight: 800;">✓</span> Prezzo indicizzato al PSV</li>
              <li style="display: flex; gap: 12px;"><span style="color: var(--secondary); font-weight: 800;">✓</span> Corrispettivo annuo fisso per 12 mesi</li>            </ul>
            <a href="contatti.php?offerta=Family%20Gas" class="btn-primary" style="margin-top: auto; display: block; text-align: center; background: var(--secondary); color: #fff; padding: 16px; border-radius: 99px; text-decoration: none; font-weight: 700; font-size: 16px;">Richiedi Family Gas</a>
          </div>
        </div>
      ...
      <!-- ===================== TRIS ===================== -->
      <div style="text-align: center; margin-bottom: 12px;">
        <span style="display: inline-block; background: var(--secondary); color: #fff; padding: 8px 20px; border-radius: 99px; font-weight: 700; font-size: 13px; text-transform: uppercase; letter-spacing: 1px;">Offerte Tris</span>
      </div>
        ...
        <div class="offer-card" style="border: 1px solid #E4E4E7; border-radius: 24px; overflow: hidden; display: flex; flex-direction: column; background: #fff; box-shadow: 0 10px 30px rgba(0,0,0,0.05);">
          ...
          <div class="offer-body" style="padding: 40px; display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <ul style="list-style: none; padding: 0; margin: 0 0 32px; display: flex; flex-direction: column; gap: 16px; color: #3F3F46; font-size: 16px;">
              <li style="display: flex; gap: 12px;"><span style="color: var(--secondary); font-weight: 800;">✓</span> Prezzo indicizzato al PSV</li>
              <li style="display: flex; gap: 12px;"><span style="color: var(--secondary); font-weight: 800;">✓</span> Corrispettivo annuo fisso per 12 mesi</li>            </ul>
            <a href="contatti.php?offerta=Tris%20Gas" class="btn-primary" style="margin-top: auto; display: block; text-align: center; background: var(--secondary); color: #fff; padding: 16px; border-radius: 99px; text-decoration: none; font-weight: 700; font-size: 16px;">Richiedi Tris Gas</a>
          </div>
        </div>
