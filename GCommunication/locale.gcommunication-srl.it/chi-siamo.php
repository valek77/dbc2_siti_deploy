  ...
  <section class="about-section" style="padding: 120px 20px; overflow: hidden;">
    <div style="max-width: 1280px; margin: 0 auto; display: flex; align-items: center; gap: 80px; flex-wrap: wrap;">
      <div style="flex: 1; min-width: 400px;">
        <h2 class="section-title" style="text-align: left; font-size: 48px; margin-bottom: 32px;">Energia e Persone al
          centro</h2>
        <p style="font-size: 18px; line-height: 1.8; color: var(--accent); opacity: 0.8; margin-bottom: 24px;">
          <?= $brand ?> è stata creata da professionisti del mercato dell'energia che volevano un approccio diverso. Al
        ...
        <p style="font-size: 18px; line-height: 1.8; color: var(--accent); opacity: 0.8;">
          Il nostro traguardo è rendere la gestione dell'energia semplice per tutti. Più che semplici fornitori,
          vogliamo essere i partner ideali per il benessere energetico della tua abitazione o impresa.
        </p>
      </div>
      <div style="flex: 1; position: relative; height: 500px; min-width: 400px;">
        <img src="team_new.png" alt="Il Team <?= $brand ?>" class="hero-image-mask"
