  ...
  <section class="hero" id="hero">
    <div class="hero-text-side">
      <div class="hero-content">
        <h1 id="hero-title">Scegli l'energia di <?= $brand ?></h1>
        <p id="hero-text">Dimentica i costi imprevisti e i call center infiniti. Scegli un partner energetico che ti
          affianca con un consulente su misura per la tua abitazione.</p>
  ...
  <section class="features-section">
    <div style="max-width: 900px; margin: 0 auto 80px; text-align: center;">
      ...
      <p class="section-sub" style="font-size: 20px;">Con <?= $brand ?> sei più di un semplice cliente. Crediamo nel
        rapporto umano e vogliamo massimizzare l'efficienza della tua casa.</p>
    </div>
    ...
    <div class="features-container">
      <div class="trust-card">
        ...
        <p>Nessuna attesa telefonica. Avrai a disposizione uno specialista dell'energia che conosce i tuoi consumi e ti
          guida passo dopo passo.</p>
      </div>
      <div class="trust-card">
        <img src="icon_audit.png" alt="Audit" class="trust-mascot">
        <h4>Analisi Energetica</h4>
        <p>Studiamo le tue abitudini di consumo per individuare eventuali sprechi e offrirti soluzioni tecnologiche
    ...
    <div class="container"
      ...
      <div style="flex: 1.2; min-width: 400px;">
        ...
        <p style="font-size: 18px; line-height: 1.8; color: var(--accent); opacity: 0.8; margin-bottom: 40px;">
          Con <?= $brand ?>, l'efficientamento è **su misura**. Sfruttiamo le migliori tecnologie per trasformare la
          tua
    ...
    <div class="container"
      ...
      <div style="flex: 1.2; min-width: 300px; text-align: left; padding-left: 40px;">
        ...
        <p style="font-size: 18px; line-height: 1.8; color: var(--text-secondary); margin: 32px 0;">
          In <?= $brand ?> utilizziamo le migliori tecnologie per monitorare il mercato energetico in tempo reale.
          Questo
