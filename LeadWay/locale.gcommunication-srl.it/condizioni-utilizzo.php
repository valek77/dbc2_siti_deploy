...
?>
  ...
  <main class="legal-content">
    ...
    <strong><?= $ragioneSociale ?></strong><?php if ($sede_legale) { ?>, con sede in <strong><?= $sede_legale ?></strong><?php } ?><?php if ($p_iva) { ?>, Partita IVA e Codice Fiscale
    <strong><?= $p_iva ?></strong><?php } ?> (di seguito, la “Società”).
    <ol>
    ...
    disponibile attraverso il Sito sono di proprietà della Società <strong><?= $ragioneSociale ?></strong> o dei
