...
$pageDescription = 'La tua nuova scelta per l\'energia. Soluzioni luce e gas su misura, tariffe chiare e trasparenti, e un\'attenzione costante al risparmio e alla sostenibilità.';
...
<div class="nx-home">
  ...
  <section class="nx-hero">
    <div class="nx-wrap">
      ...
      <div class="nx-hero-grid">
        <div class="reveal">
          <span class="nx-kicker">Energia · Luce &amp; Gas</span>
          <h1>Dai energia al tuo <em>futuro</em>, oggi.</h1>
          <p class="lede"><?= htmlspecialchars($portal) ?> ti offre soluzioni energetiche semplici e trasparenti per la tua casa e la tua impresa. Scopri le nostre tariffe e inizia a risparmiare senza rinunciare alla sostenibilità.</p>
          ...
          <div class="nx-mini">
            <div><div class="n">100<em>%</em></div><div class="l">Energia Verde</div></div>
            <div><div class="n">Zero</div><div class="l">Costi Nascosti</div></div>
            <div><div class="n">24<em>/</em>7</div><div class="l">Assistenza Dedicata</div></div>
          </div>
        </div>
  ...
  <div class="nx-marquee" aria-hidden="true">
    <div class="track">
      <span>Risparmio Garantito</span><span class="st">✳</span><span>Energia Sostenibile</span><span class="st">✳</span><span>Tariffe Trasparenti</span><span class="st">✳</span><span>Assistenza Dedicata</span><span class="st">✳</span><span>Transizione Ecologica</span><span class="st">✳</span>
      <span>Risparmio Garantito</span><span class="st">✳</span><span>Energia Sostenibile</span><span class="st">✳</span><span>Tariffe Trasparenti</span><span class="st">✳</span><span>Assistenza Dedicata</span><span class="st">✳</span><span>Transizione Ecologica</span><span class="st">✳</span>
    </div>
  </div>
  ...
  <section class="nx-manifesto">
    <div class="nx-wrap reveal">
      <span class="nx-kicker">La nostra filosofia</span>
      <p class="lead">Vogliamo cambiare il modo in cui vivi l'energia. Non più bollette incomprensibili, ma <em>piani chiari</em> e <em>prezzi onesti</em> legati agli indici di mercato (PUN e PSV), per garantirti sempre la massima convenienza.</p>
      <div class="cols">
        <div><h4>Chiarezza assoluta</h4><p>Nessuna sorpresa in bolletta. Le nostre condizioni sono semplici da leggere e facili da capire.</p></div>
        <div><h4>Soluzioni su misura</h4><p>Studiamo le tue abitudini di consumo per offrirti la tariffa più adatta a te, tagliando gli sprechi.</p></div>
        <div><h4>Impatto zero</h4><p>Crediamo in un mondo più pulito. Per questo puntiamo su fonti rinnovabili e compensazione della CO2.</p></div>
      </div>
    </div>
  </section>
  ...
  <div class="nx-reel">
    ...
    <div class="ov">
      <div class="nx-wrap">
        <h2 class="reveal">L'energia di domani, a tua disposizione <em>ora</em>.</h2>
      </div>
    </div>
  </div>
  ...
  <section class="nx-steps">
    <div class="nx-wrap">
      <div class="reveal" style="margin-bottom:48px;">
        <span class="nx-kicker">Il percorso</span>
        <h2 class="section-title" style="text-align:left; margin:18px 0 0;">Passare a noi è <em style="font-style:italic;color:var(--primary);">semplice</em> e veloce.</h2>
      </div>
      <div class="nx-step reveal"><div class="idx">01</div><div><h3>Analisi della spesa</h3><p>Inviaci la tua ultima bolletta: i nostri consulenti troveranno subito i margini di miglioramento per te.</p></div></div>
      <div class="nx-step reveal"><div class="idx">02</div><div><h3>Proposta personalizzata</h3><p>Ricevi un piano tariffario studiato esclusivamente sui tuoi reali bisogni energetici.</p></div></div>
      <div class="nx-step reveal"><div class="idx">03</div><div><h3>Zero burocrazia</h3><p>Pensiamo a tutto noi. Dalla disdetta al vecchio operatore fino alla nuova attivazione della fornitura.</p></div></div>
      <div class="nx-step reveal"><div class="idx">04</div><div><h3>Risparmio immediato</h3><p>Inizia a beneficiare della tua nuova tariffa, monitorando i consumi in modo intelligente e continuo.</p></div></div>
    </div>
  </section>
  ...
  <section class="nx-offers">
    <div class="nx-wrap">
      <div class="head reveal">
        <div>
          <span class="nx-kicker">Le nostre soluzioni</span>
          <h2 class="section-title" style="text-align:left; margin:18px 0 0;">Trova la tariffa <em style="font-style:italic;color:var(--primary);">perfetta</em> per te.</h2>
        </div>
...
<?php endforeach; ?>
    ...
    <div class="nx-wrap">
      <div class="nx-calc reveal">
        <div class="nx-calc-grid">
          <div>
            <span class="nx-kicker" style="color:var(--accent-hi);">Calcola il risparmio</span>
            <h2>Scopri quanto puoi <em>tagliare</em> in bolletta.</h2>
            <p>Inserisci quanto spendi mediamente ogni mese per luce e gas e scopri subito il tuo potenziale di risparmio annuo.</p>
          </div>
          <div>
  ...
  <section>
    <div class="nx-feature-row reverse reveal">
      <div class="body">
        <span class="nx-kicker">Monitoraggio Intelligente</span>
        <h2>I tuoi consumi, sempre <em>sotto controllo</em>.</h2>
        <p>Grazie ai nostri strumenti, potrai verificare l'andamento dei tuoi consumi e ricevere consigli utili per ottimizzare la tua spesa energetica mese dopo mese.</p>
        <ul>
          <li><span style="color:var(--primary);font-weight:800;">✓</span> Analisi chiara e trasparente dei tuoi prelievi</li>
          <li><span style="color:var(--primary);font-weight:800;">✓</span> Suggerimenti pratici per ridurre gli sprechi</li>
          <li><span style="color:var(--primary);font-weight:800;">✓</span> Supporto continuo per <b>ottimizzare i costi</b></li>
        </ul>
    ...
    <div class="nx-feature-row dark reveal">
      ...
      <div class="body">
        <span class="nx-kicker" style="color:var(--accent-hi);">Chi Siamo</span>
        <h2>Un team dedicato alla tua <em>tranquillità</em>.</h2>
        <p>Siamo professionisti dell'energia, impegnati ogni giorno per offrirti un servizio affidabile, conveniente e sempre al tuo fianco in caso di necessità. Dimentica la burocrazia, pensiamo a tutto noi.</p>
  ...
  <section class="nx-quote">
    <div class="nx-wrap reveal">
      ...
      <blockquote>L'energia migliore è quella che rispetta l'ambiente e alleggerisce la tua bolletta, senza compromessi.</blockquote>
      <div class="by">— Il Nostro Team</div>
    </div>
  </section>
  ...
  <section class="nx-cta">
    <div class="nx-wrap">
      <div class="nx-cta-inner reveal">
        <h2>Pronto a fare il salto verso l'<em>efficienza</em> energetica?</h2>
        <p>Richiedi un preventivo gratuito e senza impegno. I nostri consulenti sono pronti ad aiutarti a scegliere l'offerta giusta.</p>
