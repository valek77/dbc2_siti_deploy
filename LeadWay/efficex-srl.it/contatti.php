      ...
      <div class="contact-grid" style="grid-template-columns: 1fr; max-width: 720px; margin: 0 auto;">
        ...
        <div id="contatto-form">
          <div class="contact-form">
            ...
            <div id="conferma" hidden style="text-align: center; padding: 32px 0; margin-top: 20px; background: #fff8df; border: 1px solid #f1bc1b; border-radius: var(--r-md); color: #a31558;">
