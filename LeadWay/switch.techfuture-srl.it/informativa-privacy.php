...
?>
  ...
  <main class="legal-content">
    ...
    <p>I dati personali inseriti nel presente form saranno trattati da <strong><?= $titolareNome ?></strong>, in qualità di Titolare del trattamento, per gestire la richiesta di informazioni e ricontatto dell’utente e per fornire consulenza commerciale relativa a offerte luce e gas, anche riferibili a <?= $switch ?>.</p>
    ...
    <p>Per garantire trasparenza sui ruoli assunti nelle diverse fasi del trattamento:</p>
    <ul>
      <li><strong>Fase di raccolta e ricontatto commerciale:</strong> <?= $titolareNome ?> agisce come <strong>Titolare autonomo del trattamento</strong> per la gestione della richiesta dell’utente, la prima consulenza commerciale e il ricontatto.</li>
      <li><strong>Fase di proposta e contratto con il venditore finale:</strong> <?= $switch ?> agisce come <strong>Titolare autonomo del trattamento</strong> per le finalità connesse alla proposta commerciale, alla contrattualizzazione e alla gestione della fornitura.</li>
      <li><strong>Attività svolte per conto del venditore finale:</strong> qualora <?= $titolareNome ?> tratti dati per conto di <?= $switch ?> (ad esempio nella predisposizione o nell’inoltro della proposta e nelle attività contrattuali svolte per suo conto), opera in qualità di <strong>Responsabile del trattamento ai sensi dell’art. 28 del GDPR</strong>, designato da <?= $switch ?> e vincolato alle relative istruzioni.</li>
    </ul>
...
<?php endif; ?>    </p>
    ...
    <span class="section-subhead">d) Trasmissione o messa a disposizione dei dati a <?= $switch ?></span>
    ...
    <ul>
      ...
      <li>dati trattati da <?= $titolareNome ?> per conto di <?= $switch ?> nella fase commerciale o contrattuale, in qualità di Responsabile del trattamento ex art. 28 GDPR: secondo le istruzioni di <?= $switch ?> e secondo quanto indicato nell’informativa privacy del venditore finale;</li>
    ...
    <p>Il sito utilizza esclusivamente cookie tecnici necessari al suo funzionamento. Non vengono utilizzati cookie di profilazione, analitici, di marketing o di terze parti; per tali cookie tecnici non è richiesto il consenso dell’utente.</p>
    <p>Le informazioni complete sugli strumenti utilizzati e sulle relative finalità sono disponibili nella <a href="cookie-policy.php">Cookie Policy</a> del sito.</p>
    ...
    <h2>15. Informativa privacy di <?= $switch ?></h2>
    ...
    <p>L’informativa privacy di <?= $switch ?> sarà resa disponibile prima della sottoscrizione della proposta contrattuale e/o tramite i canali ufficiali del venditore.</p>
