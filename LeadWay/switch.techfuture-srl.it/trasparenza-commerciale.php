...
?>
  ...
  <main class="privacy-box">
    ...
    <h2>Chi siamo</h2>
    <p><strong><?= $ragioneSociale ?></strong> è una società operante nel settore dei servizi di contact center, consulenza commerciale, telemarketing, teleselling e supporto alla valutazione di offerte luce e gas.</p>
    <p><?= $ragioneSociale ?> opera come <strong>agenzia incaricata</strong> per la promozione di offerte luce e gas di venditori autorizzati. Il contratto di fornitura, ove sottoscritto dal cliente, viene concluso con il venditore indicato nella documentazione precontrattuale e contrattuale consegnata prima della sottoscrizione.</p>
    ...
    <div class="data-card">
      <strong><?= $ragioneSociale ?></strong> — Società a socio unico<br>
...
<?php if ($coDpoEmail !== ''): ?>      DPO / Responsabile della Protezione dei Dati<br>
      E-mail: <a href="mailto:<?= $coDpoEmail ?>"><?= $coDpoEmail ?></a><?php endif; ?>
    </div>
    ...
    <hr>
    <p style="font-size: 14px; color: var(--muted); text-align: center;">Ultimo aggiornamento: <?= $dataAgg ?></p>
  </main>
