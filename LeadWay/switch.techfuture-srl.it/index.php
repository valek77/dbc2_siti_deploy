...
$metaDescription = $OPERATORE_ENERGETICO . ' ti offre le migliori soluzioni per luce e gas. Scopri le offerte per casa e azienda con prezzi trasparenti e assistenza dedicata.';
        ...
        <div class="hero-slide active">
          ...
          <div class="container">
            <div class="hero-content">
              ...
              <p class="lede"><?= $OPERATORE_ENERGETICO ?> ti guida nel mercato libero con offerte trasparenti. Prezzi indicizzati al mercato e zero burocrazia.</p>
  ...
  <section class="section how-it-works section-on-dark">
    <div class="container">
      <div class="section-head">
        ...
        <p class="section-sub">Cambiare fornitore con <?= $OPERATORE_ENERGETICO ?> è veloce e non richiede alcun intervento tecnico in casa.</p>
      </div>
  ...
  <section class="section">
    <div class="container">
      <div class="split reverse">
        ...
        <div class="reveal">
          <span class="eyebrow"><span class="dot"></span> Perché scegliere <?= $OPERATORE_ENERGETICO ?></span>
      ...
      <div class="reviews-grid">
        <div class="rv-panel">
          <div>
            ...
            <p>Migliaia di famiglie e imprese hanno scelto <?= $OPERATORE_ENERGETICO ?> per la loro fornitura di energia.</p>
          </div>
