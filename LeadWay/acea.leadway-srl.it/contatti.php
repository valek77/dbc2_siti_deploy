  ...
  <div class="floating-cards" style="margin-top: -100px; display: flex; justify-content: center;">
    <div class="f-card" style="max-width: 500px; width: 100%;">
      ...
      <p>Il nostro team di esperti è pronto a rispondere a ogni tua domanda.
        <?php if ($COMPANY['email_supporto'] !== '') { ?><br><strong><a href="mailto:<?= $COMPANY['email_supporto'] ?>" style="color:var(--accent);text-decoration:underline;"><?= $COMPANY['email_supporto'] ?></a></strong><?php } ?>
        <?php if ($COMPANY['telefono'] !== '') { ?><br><strong><a href="tel:<?= $COMPANY['telefono'] ?>" style="color:var(--accent);text-decoration:underline;"><?= $COMPANY['telefono'] ?></a></strong><?php } ?>
      </p>
    </div>
  </div>
