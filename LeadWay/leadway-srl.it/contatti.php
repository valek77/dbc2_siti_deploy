      ...
      <div style="max-width: 1000px; margin: 0 auto; display: flex; align-items: center; gap: 40px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 300px;">
          ...
          <p style="font-size: 18px; line-height: 1.6; color: rgba(255, 255, 255, 0.92);">
            Affidarsi a <?= $brand ?> significa tagliare i costi superflui potendo contare su un team di veri esperti del settore. Inviaci la tua richiesta e ottieni subito una valutazione gratuita e su misura per le tue bollette.
          </p>
        </div>
