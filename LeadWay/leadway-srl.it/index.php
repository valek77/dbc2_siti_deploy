...
?>
  ...
  <section class="sustainability-section" style="padding: 80px 20px; background: #fff;">
    <div class="container"
      ...
      <div style="flex: 1.2; min-width: 300px; text-align: left;">
        <h2 class="section-title" style="text-align: left; margin-top: 0;">Supporto costante per la tua casa o azienda</h2>
        <p style="font-size: 18px; line-height: 1.6; color: var(--text-label); margin-bottom: 32px;">
          Che tu sia un'impresa che cerca maggiore efficienza per le proprie linee, o un privato che vuole tagliare i costi della bolletta energetica, i nostri professionisti ti guideranno con chiarezza verso la soluzione ideale.
        </p>
        <a href="tariffe.php" class="btn-primary" style="display: inline-block;">Le nostre offerte</a>
      </div>
      <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
