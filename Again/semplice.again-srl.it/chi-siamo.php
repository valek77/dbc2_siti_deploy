...
$pageDescription = $_brand . ' è un team di consulenti energetici specializzati nelle offerte ' . $OPERATORE['nome_marketing'] . '. Scopri la nostra storia, i nostri valori e il nostro approccio.';
    ...
    <div class="container">
      <div class="split">
        <div>
          ...
          <p style="font-size:17px; color:var(--muted); line-height:1.75; margin:0 0 20px;"><?= $brandName ?> nasce dalla volontà di trasformare il rapporto tra le persone e la loro bolletta. Non siamo solo rivenditori autorizzati <?= $OPERATORE['nome_marketing'] ?>: siamo consulenti che mettono la chiarezza e il risparmio al primo posto.</p>
