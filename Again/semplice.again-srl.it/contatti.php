...
$pageDescription = 'Contatta ' . $_brand . ' per una consulenza gratuita sulle offerte ' . $OPERATORE['nome_marketing'] . '. Rispondiamo entro 24 ore lavorative.';
      ...
      <div class="contact-wrapper" id="form">
        ...
        <div class="contact-sidebar">
          ...
          <div class="offer-promo-card">
            <div style="font-size:11px; color:rgba(255,255,255,.7); font-weight:700; text-transform:uppercase; margin-bottom:4px;"><?= $OPERATORE['nome_marketing'] ?></div>
