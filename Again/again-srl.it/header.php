<?php
/**
 * header.php — testata comune a tutte le pagine (again-srl.it).
 *
...
$brandName = $LANDING_PAGE['nome_portale'] !== ''
    ...
    : ($LANDING_PAGE['titolo'] !== ''
        ? $LANDING_PAGE['titolo']
        : ($COMPANY['company_name'] !== '' ? $COMPANY['company_name'] : 'AGAIN sistema'));
// Logo testata: dall'API se presente, altrimenti l'immagine locale del brand.
$logoHeader = $LANDING_PAGE['logo_url'] !== '' ? $LANDING_PAGE['logo_url'] : 'LOGO_again.png';
?>
<!doctype html>
<html lang="it">
  ...
  <header class="main-header">
    <div class="header-container">
      <a href="index.php" class="logo"
        style="display: flex; align-items: center; gap: 10px; color: var(--accent);"><img src="<?= $logoHeader ?>"
          alt="<?= $brandName ?>" class="logo-img" style="max-height: 48px; width: auto;"></a>
      <nav class="nav-links">
