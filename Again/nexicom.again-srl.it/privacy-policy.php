...
<?php } ?>
    ...
    <ul>
      <li><a href="mailto:dpo@again-srl.it">dpo@again-srl.it</a></li>
    </ul>
...
<?php } ?>
    ...
    <p>Per esercitare la revoca è possibile scrivere a <a href="mailto:privacy@again-srl.it">privacy@again-srl.it</a>.</p>
