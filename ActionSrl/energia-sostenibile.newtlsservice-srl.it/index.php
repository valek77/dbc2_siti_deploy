...
?>
  ...
  <section class="features-section" style="background: var(--bg-page); padding: 100px 20px;">
  ...
  <section class="efficiency-section" style="padding: 100px 20px; background: var(--bg-cream); overflow: hidden;">
    <div class="container" style="max-width: 1280px; margin: 0 auto; display: flex; align-items: center; gap: 80px; flex-wrap: wrap;">
      ...
      <div style="flex: 1; min-width: 400px;">
        <img src="efficiency_tech.jpg" alt="Efficienza Tecnologica" style="width: 100%; border-radius: var(--radius-lg); border: 1px solid var(--border); box-shadow: 0 0 0 1px rgba(255,176,32,0.25), 0 30px 60px -20px rgba(255,176,32,0.4);">
      </div>
    </div>
  </section>
  ...
  <section class="info-section" style="padding: 100px 20px; background: var(--bg-page); color: var(--text-dark);">
    <div class="container"
      ...
      <div style="flex: 1; min-width: 300px; display: flex; justify-content: center;">
        <img src="team_new.jpg" alt="Il Team <?= $brand ?>"
          style="max-width: 100%; height: auto; border-radius: var(--radius-lg); border: 1px solid var(--border); box-shadow: 0 0 0 1px rgba(255,176,32,0.25), 0 30px 60px -20px rgba(255,176,32,0.4);">
      </div>
