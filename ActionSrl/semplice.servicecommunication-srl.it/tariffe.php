...
$pageDesc = "Tutte le offerte $OPERATORE_ENERGETICO disponibili tramite $brand. Tariffe luce e gas per uso domestico con prezzi indicizzati al mercato.";
...
?>
  ...
  <section class="page-hero">
    ...
    <div class="inner">
      <span class="eyebrow" style="color:var(--primary-light);"><span class="dot" style="background:var(--primary-light);"></span> Offerte <?= $OPERATORE_ENERGETICO ?></span>
  ...
  <section class="section">
    <div class="container">
      ...
      <p style="font-size:13px; color:var(--muted-2); text-align:center; max-width:900px; margin:56px auto 0; line-height:1.7;">
        * I prezzi indicati si riferiscono alle componenti energia (PUN) e gas (PSV) con l'aggiunta degli spread indicati. Sconto di 1€/mese per domiciliazione (SDD) e 1€/mese per fattura email. Offerte soggette a condizioni contrattuali <?= $OPERATORE_ENERGETICO ?>. <?= $brand ?> è rivenditore indipendente autorizzato.
      </p>
    </div>
  </section>
  ...
  <section class="dark-section" style="padding: var(--section) 0;">
    <div class="container">
      <div class="section-head">
        ...
        <h2 class="section-title" style="color:#fff; text-align:center;">Perché scegliere<br><span style="color:var(--primary-light);"><?= $OPERATORE_ENERGETICO ?></span></h2>
  ...
  <section class="section" style="text-align:center;">
    <div class="container">
      ...
      <p style="font-size:18px; color:var(--muted); max-width:560px; margin:0 auto 36px; line-height:1.7;">Nessun vincolo di durata e nessun costo di recesso. Passa a <?= $OPERATORE_ENERGETICO ?> con <?= $brand ?>.</p>
      <a href="contatti.php" class="btn-primary" style="font-size:17px; padding:16px 44px;">Parla con un esperto →</a>
    </div>
  </section>

  <script>
    const OPERATORE = <?= json_encode(html_entity_decode($OPERATORE_ENERGETICO, ENT_QUOTES, 'UTF-8')) ?>;
    const offers = [
  { id:'pun-386', cat:'luce-res', ribbon:'luce-res', tag:'⚡ Luce Casa', top:false,
    nome:'PUN INDEX GME DOMESTICO 386', tipo:'Prezzo Variabile · Indicizzato PUN',
    rid:'PUN Index GME + 0,055 €/kWh', boll:null,
    note:'Energia elettrica per uso domestico. Spread invariato dal 13° mese. Pagamento con SDD, bonifico o bollettino.',
    feats:['Spread fisso F1/F2/F3: + 0,055 €/kWh','Quota fissa 456,00 €/POD/anno','PUN Index GME aggiornato mensilmente','Uso domestico · Mercato Libero'] },
  { id:'pun-cs-386', cat:'luce-res', ribbon:'luce-res', tag:'⚡ Luce Casa', top:true,
    nome:'PUN INDEX GME DOMESTICO CS 386', tipo:'Prezzo Variabile · Indicizzato PUN',
    rid:'PUN Index GME + 0,05 €/kWh', boll:null,
    note:'Energia elettrica per uso domestico. Spread invariato dal 13° mese. Pagamento con SDD, bonifico o bollettino.',
    feats:['Spread fisso F1/F2/F3: + 0,05 €/kWh','Quota fissa 456,00 €/POD/anno','PUN Index GME aggiornato mensilmente','Uso domestico · Mercato Libero'] },
  { id:'psv-386', cat:'gas-res', ribbon:'gas-res', tag:'🔥 Gas Casa', top:false,
    nome:'PSV DOMESTICO 386', tipo:'Prezzo Variabile · Indicizzato PSV',
    rid:'PSV + 0,45 €/Smc', boll:null,
    note:'Gas naturale per uso domestico. Spread invariato dal 13° mese. Pagamento con SDD, bonifico o bollettino.',
    feats:['Spread fisso: + 0,45 €/Smc','Quota fissa 648,00 €/PDR/anno','PSV (Day Ahead) aggiornato mensilmente','Uso domestico · Mercato Libero'] },
  { id:'psv-cs-386', cat:'gas-res', ribbon:'gas-res', tag:'🔥 Gas Casa', top:true,
    nome:'PSV DOMESTICO CS 386', tipo:'Prezzo Variabile · Indicizzato PSV',
    rid:'PSV + 0,42 €/Smc', boll:null,
    note:'Gas naturale per uso domestico. Spread invariato dal 13° mese. Pagamento con SDD, bonifico o bollettino.',
    feats:['Spread fisso: + 0,42 €/Smc','Quota fissa 648,00 €/PDR/anno','PSV (Day Ahead) aggiornato mensilmente','Uso domestico · Mercato Libero']}
    ];
    ...
    function card(o) {
      return `<article class="offer-card" data-cat="${o.cat}">
        ...
        <div class="offer-body">
          <div style="font-size:12px; color:var(--muted); font-weight:700; text-transform:uppercase; letter-spacing:0.5px; margin-bottom:8px;">${OPERATORE}</div>
          ...
          <div class="offer-price-box">
            ...
            <div class="offer-price-alt">Prezzo indicizzato · aggiornamento mensile</div>
          </div>
