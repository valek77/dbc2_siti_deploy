...
// Nome dell'operatore energetico (ragione sociale, con fallback commerciale).
...
<?php if ($LANDING_PAGE['mostra_consenso_1'] !== '') { ?>
                <label class="consent-label">
                  ...
                  <span style="font-weight:700;">Richiedo di essere ricontattato da <?= $operatoreNome ?>, tramite il partner commerciale <?= $COMPANY['company_name'] ?>, per ricevere informazioni e proposte commerciali relative alla fornitura di energia elettrica e/o gas. *</span>
                </label>
<?php } ?>
<?php if ($LANDING_PAGE['mostra_consenso_2'] !== '') { ?>
                <label class="consent-label" style="margin-top:12px;">
                  <input type="checkbox" name="consenso_marketing" style="flex-shrink:0;margin-top:3px;">
                  <span style="font-weight:700;">Acconsento a ricevere comunicazioni promozionali da <?= $operatoreNome ?> tramite telefono, email, SMS e altri strumenti di comunicazione.</span>
                </label>
<?php } ?>
              </div>
