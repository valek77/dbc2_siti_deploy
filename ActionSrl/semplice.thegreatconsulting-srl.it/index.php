...
?>
        ...
        <div class="hero-content">
          ...
          <div class="hero-calculator">
            <div class="calc-input-group">
              <label for="hero-bill">Spesa media mensile Luce e Gas (€)</label>
              <div class="input-wrapper">
                <input type="number" id="hero-bill" placeholder="Es. 150" min="20" max="2000">
                <button type="button" id="btn-hero-calc">Calcola Risparmio</button>
              </div>
            </div>
            <div id="hero-calc-result" class="calc-result" style="display:none;">
  ...
  <section class="trust-strip">
    <div class="trust-track">
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2l8 4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6l8-4z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Energia 100% Rinnovabile</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> Tariffe Trasparenti e Semplici</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M22 16.92V20a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 015 13.18 19.79 19.79 0 011.92 4.55 2 2 0 013.92 2.5h3.08a2 2 0 012 1.72c.13.96.36 1.9.69 2.8a2 2 0 01-.45 2.11L8.09 10.5a16 16 0 006 6l1.37-1.15a2 2 0 012.11-.45c.9.33 1.84.56 2.8.69a2 2 0 011.72 2.03z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> Assistenza Dedicata ESG</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2v6m0 8v6m10-10h-6M8 12H2" stroke="currentColor" stroke-width="2" stroke-linecap="round"/><circle cx="12" cy="12" r="3" stroke="currentColor" stroke-width="2"/></svg> Nessuna Interruzione del Servizio</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path d="M8 12l3 3 5-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Consulenza e Audit Gratuiti</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M12 2l8 4v6c0 5-3.5 9-8 10-4.5-1-8-5-8-10V6l8-4z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M9 12l2 2 4-4" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Energia 100% Rinnovabile</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> Tariffe Trasparenti e Semplici</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M22 16.92V20a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 015 13.18 19.79 19.79 0 011.92 4.55 2 2 0 013.92 2.5h3.08a2 2 0 012 1.72c.13.96.36 1.9.69 2.8a2 2 0 01-.45 2.11L8.09 10.5a16 16 0 006 6l1.37-1.15a2 2 0 012.11-.45c.9.33 1.84.56 2.8.69a2 2 0 011.72 2.03z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> Assistenza Dedicata ESG</span>
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"/><path d="M8 12l3 3 5-6" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg> Consulenza e Audit Gratuiti</span>
  ...
  <!-- ===== Cosa offriamo (Semplice Gas & Luce) ===== -->
  <section class="section features illumia-section">
    <div class="container">
      <div class="section-head">
        ...
        <!-- Semplice Gas & Luce Toggle Selector -->
      ...
      <!-- Grid per Casa (Visible by default) -->
      <div id="grid-casa" class="illumia-grid bento-grid">
          ...
          <div class="illumia-card-right">
            ...
            <div class="co2-calculator">
              ...
              <div class="co2-result">
                🌳 CO₂ evitate: <strong id="co2-saved-casa">1.350</strong> kg
              </div>
            </div>
          </div>
        </article>
        ...
        <article class="illumia-card border-combo featured-combo card-bento-3x">
          ...
          <div class="illumia-card-right">
            <ul class="illumia-details">
              <li><span class="checkmark">✓</span> Indicizzata al PUN Index GME con carta Logicard Casa (contributo 168 €+IVA/anno).</li>
              <li><span class="checkmark">✓</span> 1,00 € sconto bolletta via e-mail</li>
              <li><span class="checkmark">✓</span> 1,00 € sconto addebito SDD</li>
              <li><span class="checkmark">✓</span> <b>Corrispettivo annuo:</b> 456 €/POD/anno</li>
            </ul>
      ...
      <!-- Grid per Impresa (Hidden by default) -->
      <div id="grid-business" class="illumia-grid bento-grid" style="display:none;">
        ...
        <article class="illumia-card border-luce card-bento-2x">
          ...
          <div class="illumia-card-right">
            ...
            <div class="co2-calculator">
              ...
              <p class="co2-sub">Stima la riduzione delle emissioni della tua azienda:</p>
              <div class="co2-control">
                <input type="range" class="co2-slider" min="5000" max="50000" step="2500" value="15000" id="co2-range-bus">
                <div class="co2-val"><span id="co2-kwh-bus">15000</span> kWh/anno</div>
              </div>
              <div class="co2-result">
                🌳 CO₂ evitate: <strong id="co2-saved-bus">6.750</strong> kg
              </div>
            </div>
          </div>
        </article>
        ...
        <article class="illumia-card border-combo featured-combo card-bento-3x">
          ...
          <div class="illumia-card-right">
            <ul class="illumia-details">
              <li><span class="checkmark">✓</span> con carta Logicard Casa (contributo 168 €+IVA/anno).</li>
              <li><span class="checkmark">✓</span> 1,00 € sconto bolletta via e-mail</li>
              <li><span class="checkmark">✓</span> 1,00 € sconto addebito SDD</li>
              <li><span class="checkmark">✓</span> <b>Corrispettivo annuo:</b> 648 €/PDR/anno</li>
            </ul>
    ...
    <div class="container">
      ...
      <div class="hiw-steps">
        <div class="hiw-step">
          ...
          <h5>Diagnosi dei Consumi</h5>
          <p>Condividi una bolletta recente per consentire ai nostri analisti di mappare la tua curva di carico attuale e rilevare inefficienze tariffarie.</p>
        </div>
        <div class="hiw-step">
          <div class="hiw-num">02</div>
          <h5>Ingegnerizzazione</h5>
          <p>Elaboriamo una proposta personalizzata e parametrata sulle reali fasce di prelievo per garantire una reale riduzione della spesa energetica.</p>
        </div>
        <div class="hiw-step">
          <div class="hiw-num">03</div>
          <h5>Gestione Amministrativa</h5>
          <p>Gestiamo direttamente tutte le pratiche burocratiche di recesso dal precedente fornitore, senza alcun onere operativo a tuo carico.</p>
        </div>
        <div class="hiw-step">
          <div class="hiw-num">04</div>
          <h5>Attivazione e Reporting</h5>
          <p>Avvio automatico della fornitura verde con accesso immediato all'area riservata e al monitoraggio delle metriche di sostenibilità.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- ===== Audit Energetico (Split Block 2) ===== -->
  <section class="split-block split-block-reverse">
    <div class="split-block-content teal-bg reveal">
      <span class="eyebrow eyebrow-light"><span class="dot"></span> Diagnostica Avanzata</span>
      <h2 class="section-title" style="text-align:left; color:#ffffff; font-size: clamp(28px, 4vw, 38px); margin: 16px 0 24px;">Audit Energetico Digitale e <span style="color:var(--accent);">prevenzione degli sprechi</span></h2>
      <p style="font-size:16.5px; color:rgba(255,255,255,0.85); line-height:1.75; margin: 0 0 24px;">
        Attraverso algoritmi proprietari di analisi dei dati di prelievo, identifichiamo inefficienze operative, sfasamenti di potenza e picchi anomali di consumo. Questo processo consente di formulare piani d'azione immediati per ridurre i costi fissi.
      </p>
      <ul style="list-style:none; padding:0; margin:0 0 36px;">
        <li style="margin-bottom:12px; display:flex; gap:10px; align-items:center; font-size:15px; color:#ffffff;"><span style="color:var(--accent); font-weight:bold;">✓</span> Monitoraggio analitico del carico orario e delle curve di prelievo</li>
    ...
    <div class="container">
      <div class="reviews-grid">
        <div class="rv-panel">
          <div>
            <div class="stars">★★★★★</div>
            <h3>Scelto da chi guarda al futuro</h3>
            <p>Migliaia di famiglie e aziende hanno ridotto i costi in bolletta e migliorato il proprio profilo di sostenibilità ambientale con la nostra consulenza.</p>
          </div>
          <div class="big">4.8<small>/5</small></div>
        </div>
        <div class="rv-cards">
          <div class="rv-card">
            <div class="quote">"</div>
            <div class="stars">★★★★★</div>
            <h5>Ottimizzazione eccellente</h5>
            <p>Grazie all'audit gratuito abbiamo compreso le inefficienze dei consumi in ufficio. Risparmio del 18% già dai primi mesi e zero intoppi.</p>
            <div class="author">
              <div class="avatar">MV</div>
              <div>
                <div class="author-name">Matteo V.</div>
                <div class="author-meta">Fornitura Ufficio</div>
              </div>
            </div>
          </div>
          <div class="rv-card">
            <div class="quote">"</div>
            <div class="stars">★★★★★</div>
            <h5>Efficienza e trasparenza</h5>
            <p>Le tariffe indicizzate al mercato sono incredibilmente chiare. Nessun costo nascosto e l'assistenza clienti risponde in pochi minuti.</p>
            <div class="author">
              <div class="avatar">ES</div>
              <div>
                <div class="author-name">Elena S.</div>
                <div class="author-meta">Fornitura Casa</div>
              </div>
            </div>
          </div>
          <div class="rv-card">
            ...
            <div class="author">
              ...
              <div>
                <div class="author-name">Fabrizio R.</div>
                <div class="author-meta">Fornitura Green</div>
              </div>
            </div>
          </div>
        </div>
...
<script>
    ...
    document.querySelectorAll('.illumia-tab').forEach(tab => {
      tab.addEventListener('click', () => {
        ...
        const gridCasa = document.getElementById('grid-casa');
        const gridBusiness = document.getElementById('grid-business');

        if (target === 'casa') {
          gridCasa.style.display = 'grid';
          gridBusiness.style.display = 'none';
        } else {
          gridCasa.style.display = 'none';
          gridBusiness.style.display = 'grid';
        }
      });
    });

    // Hero Interactive Calculator
    const btnHeroCalc = document.getElementById('btn-hero-calc');
    if (btnHeroCalc) {
    ...
    // CO2 Calculator Casa
    const rangeCasa = document.getElementById('co2-range-casa');
    const kwhCasa = document.getElementById('co2-kwh-casa');
    const savedCasa = document.getElementById('co2-saved-casa');
    if (rangeCasa && kwhCasa && savedCasa) {
      rangeCasa.addEventListener('input', (e) => {
        const val = parseInt(e.target.value);
        kwhCasa.textContent = val;
        savedCasa.textContent = Math.round(val * 0.45).toLocaleString('it-IT');
      });
    }

    // CO2 Calculator Business
    const rangeBus = document.getElementById('co2-range-bus');
    const kwhBus = document.getElementById('co2-kwh-bus');
    const savedBus = document.getElementById('co2-saved-bus');
    if (rangeBus && kwhBus && savedBus) {
      rangeBus.addEventListener('input', (e) => {
        const val = parseInt(e.target.value);
        kwhBus.textContent = val;
        savedBus.textContent = Math.round(val * 0.45).toLocaleString('it-IT');
      });
    }
  </script>
HTML;
