...
?>
  ...
  <section class="page-hero">
    <div class="container">
      ...
      <p>Richiedi un'analisi energetica senza impegno. Un nostro energy manager ti contatterà al più presto per identificare l'opzione ideale in base al tuo profilo di consumo.</p>
    </div>
    <div class="wave">
...
<?php } ?>
            ...
            <div id="conferma" hidden style="text-align: center; padding: 32px; margin-top: 20px; background: var(--primary-50); border: 1px solid var(--primary-100); border-radius: var(--r-sm); color: var(--primary-600);">
              ...
              <p style="margin: 8px 0 0; font-size: 14px; line-height:1.5;">Un consulente energetico prenderà in carico la tua pratica ed effettuerà il ricontatto appena possibile</p>
            </div>
          </div>
        </div>
