...
?>
  ...
  <!-- Hero Section -->
  <section class="hero" style="background: linear-gradient(rgba(11,11,13,0.78), rgba(11,11,13,0.92)), radial-gradient(70% 90% at 50% 40%, rgba(255,176,32,0.18), transparent 65%), url('about_landscape.jpg') center/cover no-repeat; min-height: 500px; height: 500px; display: flex; align-items: center; justify-content: center; text-align: center;">
  ...
  <section class="about-section" style="padding: 100px 20px; overflow: hidden;">
    <div style="max-width: 1280px; margin: 0 auto; display: flex; align-items: center; gap: 80px; flex-wrap: wrap;">
      ...
      <div style="flex: 1; position: relative; height: 500px; min-width: 400px;">
        <img src="team_new.jpg" alt="Il Team <?= $brand ?>" class="hero-image-mask" style="border-radius: var(--radius-lg); border: 1px solid var(--border); box-shadow: 0 0 0 1px rgba(255,176,32,0.25), -10px 30px 60px -20px rgba(255,176,32,0.4);">
      </div>
    </div>
  </section>
  ...
  <!-- Final Quote Section -->
  <section style="padding: 120px 20px; text-align: center; background: var(--bg-page);">
    <div style="max-width: 900px; margin: 0 auto;">
      <h2 style="font-size: clamp(28px, 4vw, 42px); color: var(--text-dark); line-height: 1.35; font-weight: 700; margin-bottom: 40px;">"Il nostro obiettivo non è vendere contratti, ma costruire <span style="color: var(--accent); text-shadow: 0 0 24px rgba(255,176,32,0.5);">relazioni durature</span> basate sulla fiducia e sul risparmio concreto."</h2>
      <p style="font-family: var(--font-mono); font-size: 14px; letter-spacing: 1px; color: var(--accent);">— Il Team <?= $brand ?></p>
    </div>
  </section>
