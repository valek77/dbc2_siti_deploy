...
?>
  ...
  <main class="legal-content">
    ...
    <p>Nello specifico, il Titolare del trattamento è la società <?= $responsabileData?>.</p>
...
<?php if ($COMPANY['email_dpo']) { ?>    <p>I dati di contatto del Responsabile della Protezione dei Dati (DPO), ove nominato, sono i seguenti: <strong><?= $email_dpo ?></strong>.</p>
<?php } ?>
...
<?php } ?>
<?php if ($COMPANY['email_dpo'] && $COMPANY['email_dpo'] !== $COMPANY['email_supporto']) { ?>       <li><strong><a href="mailto:" . $COMPANY['email_dpo'] . "><?= $COMPANY['email_dpo'] ?></a></strong></li>
<?php } ?>
...
<?php if ($COMPANY['email_supporto']) { ?>    <p>Per esercitare la revoca è possibile scrivere a <?= $COMPANY['email_supporto'] ?><?= ($COMPANY['email_dpo'] && $COMPANY['email_dpo'] !== $COMPANY['email_supporto']) ? ' o ' . $COMPANY['email_dpo'] : '' ?>.</p>
<?php } ?>
