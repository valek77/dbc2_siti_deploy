...
?>
  ...
  <main class="policy-doc">
    ...
    <p>Il Titolare del trattamento è <strong>Ecom S.p.A.</strong>, con sede legale in Circonvalazione Sud Bari, Km 810 70019 Triggiano (BA), C.F./P.IVA e n. Registro Imprese 08000190721, REA BA-597428, tel. 080 222 74 04 e-mail partner@semplicegaseluce.it, PEC ecomspa@pec.it, in persona del legale rapp.te p.t..</p>

    <h2>Responsabile della protezione dei dati (DPO)</h2>
    <p>Il DPO è contattabile alla casella e-mail <a href="mailto:dpo@energiacomune.com"><strong>dpo@energiacomune.com</strong></a>.</p>
    ...
    <p>Puoi esercitare in qualsiasi momento, scrivendo a <a href="mailto:dpo@energiacomune.com">dpo@energiacomune.com</a>, i seguenti diritti previsti dagli artt. 15-22 del GDPR:</p>
    <ul>
