...
// --- Titolare del trattamento: SOLO dati dall'API azienda ($COMPANY) --------
// Nessun dato cablato: i campi non forniti dall'API (REA, Registro Imprese,
// socio unico, nominativo DPO) semplicemente non compaiono.
$titolareNome = $COMPANY['company_name'] !== '' ? $COMPANY['company_name'] : 'Gruppo Grimaldi';
$titolareSede = $COMPANY['sede_legale'];
$titolarePiva = $COMPANY['p_iva'];
$titolarePec = $COMPANY['pec'];
$capitaleSociale = $COMPANY['capitale_sociale'];
$emailDpo = $COMPANY['email_dpo'];

// --- Venditore finale / operatore energetico: dati dall'API ($OPERATORE) ----
$operatore = $OPERATORE['nome_legale'] !== '' ? $OPERATORE['nome_legale'] : $OPERATORE['nome_marketing'];
...
?>
  ...
  <main class="legal-content">
    ...
    <p>I dati personali inseriti nel presente form saranno trattati da <strong><?= $titolareNome ?></strong>, in qualità di Titolare del trattamento, per gestire la richiesta di informazioni e ricontatto dell’utente e per fornire consulenza commerciale relativa a offerte luce e gas, anche riferibili a <?= $operatore ?>.</p>
    <p>Il trattamento avverrà nel rispetto del Regolamento (UE) 2016/679 (“GDPR”) e della normativa applicabile in materia di protezione dei dati personali, tutela del consumatore, telemarketing, teleselling e Registro Pubblico delle Opposizioni.</p>
    <p>I dati richiesti sono necessari per poter gestire la richiesta di ricontatto. Il mancato conferimento dei dati obbligatori non consentirà l’invio della richiesta.</p>
...
<?php } else { ?>
    <p>Qualora previsto dalla normativa vigente, il Titolare potrà designare un Responsabile della Protezione dei Dati / Data Protection Officer. I relativi dati di contatto saranno resi disponibili sul sito web o mediante specifica comunicazione all’interessato.</p>
<?php } ?>
    ...
    <h2>4. Finalità del trattamento e basi giuridiche</h2>
    <p>I dati personali potranno essere trattati per le seguenti finalità.</p>

    <span class="section-subhead">a) Gestione della richiesta dell’utente</span>
    ...
    <span class="section-subhead">b) Ricontatto telefonico per offerte luce e gas</span>
    ...
    <span class="section-subhead">c) Valutazione di offerte luce e gas</span>
    ...
    <span class="section-subhead">d) Trasmissione o messa a disposizione dei dati a <?= $operatore ?></span>
    <p>Quando l’utente manifesta interesse per un’offerta di <?= $operatore ?> o chiede di procedere alla valutazione o sottoscrizione della proposta, i dati necessari potranno essere comunicati o resi disponibili a <?= $operatore ?>.</p>
    <p>In tale fase <?= $operatore ?> tratterà i dati in qualità di Titolare del trattamento per le finalità di propria competenza.</p>
    ...
    <span class="section-subhead">e) Invio di comunicazioni tramite telefono, e-mail, SMS o WhatsApp</span>
    ...
    <span class="section-subhead">f) Gestione delle opposizioni e delle richieste di non ricontatto</span>
    ...
    <span class="section-subhead">g) Adempimenti normativi e tutela dei diritti</span>
    ...
    <h2>5. Natura del conferimento dei dati</h2>
    ...
    <h2>6. Modalità di raccolta dei dati</h2>
    ...
    <h2>7. Modalità del trattamento e misure di sicurezza</h2>
    ...
    <ul>
      ...
      <li><?= $operatore ?>, quando l’utente manifesta interesse per un’offerta o richiede di procedere alla valutazione o sottoscrizione della proposta;</li>
    ...
    <h2>9. Trasferimento dei dati fuori dallo Spazio Economico Europeo</h2>
    ...
    <h2>10. Tempi di conservazione</h2>
    ...
    <ul>
      ...
      <li>dati trattati da <?= $titolareNome ?> per conto di <?= $operatore ?> nella fase commerciale o contrattuale: secondo le istruzioni di <?= $operatore ?> e secondo quanto indicato nell’informativa privacy del venditore finale;</li>
    ...
    <h2>11. Cookie e strumenti di tracciamento</h2>
    ...
    <p>Le richieste possono essere inviate al Titolare ai recapiti indicati nella presente informativa<?= $emailDpo !== '' ? ' oppure al DPO' : '' ?>.</p>

    <h2>13. Diritto di opposizione ai contatti commerciali</h2>
    ...
    <h2>15. Informativa privacy di <?= $operatore ?></h2>
    <p>Quando l’utente sceglie di procedere con un’offerta riferibile a <?= $operatore ?>, <?= $operatore ?> tratta i dati personali in qualità di Titolare del trattamento per le finalità connesse alla proposta commerciale, alla contrattualizzazione, alla gestione della fornitura, agli adempimenti normativi, amministrativi e contrattuali di propria competenza.</p>
    <p>Per i trattamenti svolti da <?= $operatore ?> si invita l’utente a consultare l’informativa privacy del venditore finale, resa disponibile prima della sottoscrizione o tramite i canali ufficiali del venditore.</p>

    <h2>16. Aggiornamenti della privacy policy</h2>
    <p>La presente privacy policy potrà essere aggiornata in caso di modifiche normative, tecniche, organizzative o commerciali. Si invita l’utente a consultare periodicamente questa pagina per verificarne la versione più recente.</p>
  </main>
