...
$pageDescription = $brand . ' ti offre le migliori soluzioni per luce e gas. Scopri le offerte per casa e azienda con prezzi trasparenti e assistenza dedicata.';
...
?>
  ...
  <section class="trust-strip">
    <div class="trust-track">
      ...
      <span class="trust-item"><svg viewBox="0 0 24 24" fill="none"><path d="M13 2L4 14h7l-1 8 9-12h-7l1-8z" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/></svg> Partner <?= $OPERATORE_ENERGETICO ?></span>
  ...
  <section class="section how-it-works section-on-dark">
    <div class="container">
      <div class="section-head">
        ...
        <p class="section-sub">Cambiare fornitore e passare a <?= $OPERATORE_ENERGETICO ?> è veloce e non richiede alcun intervento tecnico in casa.</p>
      </div>
      ...
      <div class="timeline">
        <div class="timeline-item reveal">
          ...
          <div class="timeline-content">
            ...
            <p>Confronta le tariffe Luce o Gas di <?= $OPERATORE_ENERGETICO ?> e individua quella più adatta al tuo profilo.</p>
          </div>
        </div>
        <div class="timeline-item reveal">
          <div class="timeline-dot"></div>
      ...
      <div class="split reverse">
        ...
        <div class="reveal">
          ...
          <p style="font-size:17px; color:var(--muted); line-height:1.7; margin: 0 0 24px;">
            Con il nostro partner <?= $OPERATORE_ENERGETICO ?> puoi scegliere tra offerte a prezzo variabile indicizzato al mercato o offerte a prezzo fisso garantito per 12 mesi.
          </p>
      ...
      <div class="reviews-grid">
        <div class="rv-panel">
          <div>
            ...
            <p>Migliaia di famiglie e imprese hanno scelto i nostri partner per la loro fornitura di energia.</p>
          </div>
