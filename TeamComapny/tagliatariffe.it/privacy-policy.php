...
<head>
  ...
  <title>Privacy Policy — Sansan</title>
...
<body>
  ...
  <section class="dark-section" style="padding:80px 0; text-align:center;">
    <div class="container">
      ...
      <h1 style="color:#fff; font-size:clamp(36px,5vw,56px);">Privacy Policy</h1>
      <p style="color:rgba(255,255,255,.7); margin:16px 0 0; font-size:17px;">Informativa ai sensi del Regolamento UE 2016/679 (GDPR)</p>
    </div>
  </section>
  <div class="prose">
...
<?php } ?>
    ...
    <p style="font-size:.85em; font-style:italic; color:var(--muted-2); margin-bottom:10px;">Art. 13, par.1, lett. d</p>
    ...
    <p><strong>Dati personali comuni forniti volontariamente dall'Utente</strong></p>
    <p>Il Titolare tratta i dati personali conferiti volontariamente dall'Utente mediante la compilazione dei moduli presenti sul Sito. Tali dati possono comprendere:</p>
    <ul>
    ...
    <p><strong>Dati relativi alle preferenze e ai consumi energetici</strong></p>
    <p>Ai fini dell'erogazione del servizio di comparazione e consulenza, l'Utente può fornire informazioni relative alle proprie esigenze e abitudini di consumo nel settore dell'energia. Tali informazioni possono includere, a titolo esemplificativo: fornitore attuale e costo della fornitura, consumo energetico annuo (kWh o mc), tipologia di abitazione e numero di occupanti, caratteristiche tecniche del contatore o del servizio richiesto. Tali dati sono utilizzati esclusivamente per individuare e proporre offerte commerciali compatibili con le esigenze dell'Utente.</p>
    <p><strong>Dati contenuti nei documenti caricati dall'Utente</strong></p>
    ...
    <p style="font-size:.85em; font-style:italic; color:var(--muted-2); margin-bottom:10px;">Art. 13, par.2, lett. e</p>
    ...
    <p>Il trattamento dei dati personali avviene mediante strumenti elettronici e informatici idonei a garantire la sicurezza, l'integrità e la riservatezza dei dati, nel rispetto delle disposizioni normative vigenti. Il Titolare adotta misure tecniche e organizzative adeguate, tra cui:</p>
    <ul>
    ...
    <p style="font-size:.85em; font-style:italic; color:var(--muted-2); margin-bottom:10px;">Art. 13, par.1, lett. e</p>
    ...
    <p style="font-size:.85em; font-style:italic; color:var(--muted-2); margin-bottom:10px;">Art. 13, par.2, lett. a</p>
    ...
    <ul>
      <li>via e-mail, all'indirizzo: <a href="mailto:garante@gpdp.it">garante@gpdp.it</a> / <a href="mailto:urp@gpdp.it">urp@gpdp.it</a></li>
