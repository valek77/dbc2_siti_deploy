  ...
  <main style="margin-top: 60px; background: #fff;">
    ...
    <section class="green-intro"
      ...
      <div style="max-width: 1000px; margin: 0 auto; display: flex; align-items: center; gap: 40px; flex-wrap: wrap;">
        <div style="flex: 1; min-width: 300px;">
          <h2 class="section-title" style="text-align: left; margin-top: 0; color: #ffffff;">Siamo qui per te,
            insieme</h2>
          <p style="font-size: 18px; line-height: 1.6; color: rgba(255, 255, 255, 0.92);">
            Scegliere <?= $brandName ?> significa affidarsi a un team di professionisti. Ti aiutiamo a tagliare i costi delle bollette selezionando le migliori offerte del mercato.
          </p>
        </div>
        <div style="flex: 0.8; min-width: 200px; display: flex; justify-content: center;">
          <img src="hero_customer_service.png" alt="Assistenza Clienti"
    ...
    <section class="green-outro"
      ...
      <div
        ...
        <div style="flex: 0.8; min-width: 200px; display: flex; justify-content: center;">
          <img src="saving_money.png" alt="Risparmio"
            style="max-width: 300px; height: auto; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.15);">
        </div>
        <div style="flex: 1; min-width: 300px;">
          <h2 class="section-title" style="text-align: left; margin-top: 0; color: #ffffff;">La nostra promessa
          </h2>
          <p style="font-size: 18px; line-height: 1.6; color: rgba(255, 255, 255, 0.92);">
            Non ci limitiamo a confrontare tariffe, promuoviamo un vero risparmio nel tempo. Con le nostre soluzioni energetiche e per la telefonia, rendiamo la tua vita più semplice e conveniente.
          </p>
        </div>
      </div>
    </section>
